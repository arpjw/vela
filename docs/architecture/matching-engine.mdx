...
The benchmark result — 1.08 μs median match latency at 57.3k ops/sec — is achieved entirely within this single-threaded model.
...
| match_order (limit, full fill) | 1.08 μs | 2.3 μs | 5.1 μs | 57.3k/s |
...
|---|---|---|---|
| p50 latency | 1.08 μs | 5.1 μs | 4.7× faster |
| p99.9 latency | 5.1 μs | 19.2 μs | −73% |
| Throughput | 57.3k/s | 12.2k/s | 4.7× higher |
