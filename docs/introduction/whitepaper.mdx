...
Benchmarks show 1.08 μs median match latency and 57,300 operations per second, representing a 4.7× throughput improvement over the Pulse baseline with a 73% reduction in p99.9 tail latency.
